...
aliases['bVetoSF'] = {
    #'expr': 'TMath::Exp(Sum(LogVec((CleanJet_pt>20 && AbsVec(CleanJet_eta)<2.5)*Jet_btagSF_shape[CleanJet_jetIdx]+1*(CleanJet_pt<20 || AbsVec(CleanJet_eta)>2.5))))',
    'expr': 'TMath::Exp(Sum(LogVec((CleanJet_pt>20 && AbsVec(CleanJet_eta)<2.5)*Take(Jet_btagSF_shapeFix,CleanJet_jetIdx)+1*(CleanJet_pt<20 || AbsVec(CleanJet_eta)>2.5))))',
    'samples': mc
}
...
aliases['btag0SF'] = {
    ...
    'expr': 'TMath::Exp(Sum(LogVec((CleanJet_pt>20 && CleanJet_pt<30 && AbsVec(CleanJet_eta)<2.5)*Take(Jet_btagSF_shapeFix,CleanJet_jetIdx)+1*(CleanJet_pt<20 || CleanJet_pt>30 || AbsVec(CleanJet_eta)>2.5))))',
    'samples': mc
}
...
aliases['btagnSF'] = {
    ...
    'expr': 'TMath::Exp(Sum(LogVec((CleanJet_pt>30 && AbsVec(CleanJet_eta)<2.5)*Take(Jet_btagSF_shapeFix,CleanJet_jetIdx) + (CleanJet_pt<30 || AbsVec(CleanJet_eta)>2.5))))',
    'samples': mc
}
